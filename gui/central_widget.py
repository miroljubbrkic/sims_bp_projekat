...
class CentralWidget(QtWidgets.QWidget):
    def __init__(self, parent, data_list):
        ...
        # add = QtWidgets.QAction("ADD", self.tool_bar)
        # self.tool_bar.addAction(add)
        # delete = QtWidgets.QAction("DELETE", self.tool_bar)
        # # def remove():
        # #     indexes = self.table.selectionModel().selectedIndexes()
        # #     for index in indexes:
        # #         self.table.model().removeRows(index.row(), 1, QtCore.QModelIndex())
        # #         break
